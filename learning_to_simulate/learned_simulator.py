...
class LearnedSimulator(snt.AbstractModule):
  ...
  def _build(self, position_sequence, control_input_sequence, n_particles_per_example,
    ...
    Args:
      ...
      control_input_sequence: the same size as position sequence, which indicates the robot control input
    ...
    input_graphs_tuple = self._encoder_preprocessor(
        position_sequence, control_input_sequence, n_particles_per_example, global_context,
        particle_types)
  ...
  def _encoder_preprocessor(
      self, position_sequence, control_input_sequence, n_node, global_context, particle_types):
    ...
    # Features for the control input (Only append the most recent one)
    flat_control_input_sequence = control_input_sequence[:, -1]
    node_features.append(flat_control_input_sequence)
  ...
  def get_predicted_and_target_normalized_accelerations(
      self, next_position, position_sequence_noise, position_sequence, control_input_sequence,
    ...
    Args:
      ...
      control input, the same size as position sequence. Provide the control input from the robot to each of the node
    Returns:
    ...
    input_graphs_tuple = self._encoder_preprocessor(
        noisy_position_sequence, control_input_sequence, n_particles_per_example, global_context,
        particle_types)
